...
1. Long training (25 epoch) with v3 hyperparams in both directions — see if H plateaus or continues climbing.
...
4. Qualitative figures (target-domain success cases for both directions).
